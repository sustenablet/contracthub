...
const JOB_STATUS_CONFIG: Record<string, { label: string; className: string }> = {
  scheduled: { label: "Scheduled", className: "bg-[#F59E0B]/10 text-[#F59E0B] ring-1 ring-inset ring-[#F59E0B]/20" },
  ...
  invoiced: { label: "Invoiced", className: "bg-[#F59E0B]/10 text-[#F59E0B] ring-1 ring-inset ring-[#F59E0B]/20" },
  cancelled: { label: "Cancelled", className: "bg-[#262118] text-[#8C7D6A] ring-1 ring-inset ring-[#312B20]" },
};
...
const INVOICE_STATUS_CONFIG: Record<string, { label: string; className: string }> = {
  ...
  void: { label: "Void", className: "bg-[#262118] text-[#8C7D6A] ring-1 ring-inset ring-[#312B20]" },
};
...
export default function ClientDetailPage() {
  ...
  if (!client) {
    return (
      <div className="flex flex-col items-center justify-center h-64 text-center">
        <p className="text-sm font-semibold text-[#E8DFD0] mb-2">
          Client not found
        </p>
        <button
          onClick={() => router.push("/dashboard/clients")}
          className="text-sm text-[#8C7D6A] hover:text-[#E8DFD0] font-medium"
        >
          Back to clients
        </button>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <button
        onClick={() => router.push("/dashboard/clients")}
        className="flex items-center gap-1.5 text-sm text-[#8C7D6A] hover:text-[#E8DFD0] transition-colors"
      >
      ...
      {/* Client header card */}
      <div className="bg-[#1F1B14] rounded-[6px] shadow-[0_1px_3px_rgba(0,0,0,0.4)] border border-[#312B20] p-6">
        <div className="flex flex-col sm:flex-row sm:items-start gap-5">
          {/* Avatar */}
          <div className="h-16 w-16 rounded-full bg-white/[0.06] text-[#E8DFD0] flex items-center justify-center text-xl font-bold shrink-0">
            {initials}
          </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-2 text-xs text-[#8C7D6A]">
              {client.email && (
                <div className="flex items-center gap-1.5">
                  <Mail className="h-3.5 w-3.5 text-[#4E4235]" />
                  {client.email}
                </div>
              )}
              {client.phone && (
                <div className="flex items-center gap-1.5">
                  <Phone className="h-3.5 w-3.5 text-[#4E4235]" />
                  {client.phone}
                </div>
              )}
              <div className="flex items-center gap-1.5">
                <Calendar className="h-3.5 w-3.5 text-[#4E4235]" />
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-[#8C7D6A] bg-[#1F1B14] border border-[#312B20] rounded-[6px] hover:bg-[#262118] transition-colors"
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-[6px] transition-colors ${
                deleteConfirm
                  ...
                  : "text-red-400 bg-[#1F1B14] border border-[#312B20] hover:bg-red-500/[0.06]0/100/[0.06] hover:text-red-400"
              }`}
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-[#8C7D6A] bg-[#1F1B14] border border-[#312B20] rounded-[6px] hover:bg-[#262118] transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-white bg-[#F59E0B] hover:bg-[#F59E0B]/90 rounded-[6px] shadow-sm transition-colors"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          {/* Service Address */}
          <div className="bg-[#1F1B14] rounded-[6px] shadow-[0_1px_3px_rgba(0,0,0,0.4)] border border-[#312B20] p-5">
            <div className="flex items-center gap-2 mb-3">
              <MapPin className="h-4 w-4 text-[#4E4235]" />
              <h3 className="text-xs font-bold tracking-[0.08em] text-[#5A5040] uppercase">
                Service Address
              </h3>
            </div>
            <p className="text-sm text-[#8C7D6A] leading-relaxed">
          ...
          {client.preferred_service && (
            <div className="bg-[#1F1B14] rounded-[6px] shadow-[0_1px_3px_rgba(0,0,0,0.4)] border border-[#312B20] p-5">
              <div className="flex items-center gap-2 mb-3">
                <Briefcase className="h-4 w-4 text-[#4E4235]" />
                <h3 className="text-xs font-bold tracking-[0.08em] text-[#5A5040] uppercase">
                  Preferred Service
                </h3>
              </div>
          ...
          <div className="bg-[#1F1B14] rounded-[6px] shadow-[0_1px_3px_rgba(0,0,0,0.4)] border border-[#312B20] p-5">
            <div className="flex items-center gap-2 mb-3">
              <StickyNote className="h-4 w-4 text-[#4E4235]" />
              <h3 className="text-xs font-bold tracking-[0.08em] text-[#5A5040] uppercase">
                Notes
              </h3>
            </div>
            <p className="text-sm text-[#8C7D6A] leading-relaxed whitespace-pre-wrap">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { label: "Total Jobs", value: totalJobs.toString(), color: "text-[#E8DFD0]" },
              ...
              },
              {
                ...
                color: outstanding > 0 ? "text-[#FF9F0A]" : "text-[#E8DFD0]",
              },
            ].map((stat) => (
              <div
                key={stat.label}
                className="bg-[#1F1B14] rounded-[6px] shadow-[0_1px_3px_rgba(0,0,0,0.4)] border border-[#312B20] p-4"
              >
                <p className="text-[10px] font-bold tracking-[0.1em] text-[#5A5040] uppercase mb-1.5">
                  {stat.label}
                </p>
          ...
          <div className="bg-[#1F1B14] rounded-[6px] shadow-[0_1px_3px_rgba(0,0,0,0.4)] border border-[#312B20]">
            <div className="flex items-center gap-2 px-5 py-4 border-b border-[#262118]">
              <Briefcase className="h-4 w-4 text-[#4E4235]" />
              <h3 className="text-xs font-bold tracking-[0.08em] text-[#5A5040] uppercase">
                Job History
              </h3>
              <span className="ml-auto text-[10px] font-semibold text-[#5A5040]">
            ...
            {jobs.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center px-6">
                <Briefcase className="h-8 w-8 text-[#4E4235] mb-3" />
                <p className="text-sm font-semibold text-[#8C7D6A] mb-1">
                  No jobs yet
                </p>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="bg-[#262118]/50 border-b border-[#262118]">
                      {["Date", "Service Type", "Status", "Price", "Duration", "Actions"].map(
                        (h) => (
                          <th
                            key={h}
                            className="text-left px-5 py-3 text-[11px] font-semibold text-[#8C7D6A] whitespace-nowrap"
                          >
                            {h}
                          </th>
                        )
                  ...
                  <tbody className="divide-y divide-[#262118]">
                    {jobs.map((job) => {
                      const status = JOB_STATUS_CONFIG[job.status] || {
                        label: job.status,
                        className: "bg-[#262118] text-[#8C7D6A] ring-1 ring-inset ring-[#312B20]",
                      };
                      return (
                        <tr
                          key={job.id}
                        ...
                        >
                          <td className="px-5 py-4 text-xs text-[#8C7D6A] whitespace-nowrap">
                            {formatDate(job.scheduled_date)}
                            {job.start_time && (
                              <span className="text-[#5A5040] ml-1.5">
                                {formatTime(job.start_time)}
                              </span>
                            )}
                          </td>
                          <td className="px-5 py-4 text-xs font-medium text-[#8C7D6A]">
                            {job.service_type || "\u2014"}
                          </td>
                          ...
                          <td className="px-5 py-4 text-sm font-bold text-[#E8DFD0] tabular-nums">
                            {job.price != null
                          ...
                          <td className="px-5 py-4">
                            {job.status === "completed" ? (
                              <button
                                ...
                                className="flex items-center gap-1 text-xs font-semibold text-[#8C7D6A] hover:text-[#E8DFD0] transition-colors disabled:opacity-50"
                              >
          ...
          <div className="bg-[#1F1B14] rounded-[6px] shadow-[0_1px_3px_rgba(0,0,0,0.4)] border border-[#312B20]">
            <div className="flex items-center gap-2 px-5 py-4 border-b border-[#262118]">
              <Receipt className="h-4 w-4 text-[#4E4235]" />
              <h3 className="text-xs font-bold tracking-[0.08em] text-[#5A5040] uppercase">
                Invoice History
              </h3>
              <span className="ml-auto text-[10px] font-semibold text-[#5A5040]">
            ...
            {invoices.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center px-6">
                <Receipt className="h-8 w-8 text-[#4E4235] mb-3" />
                <p className="text-sm font-semibold text-[#8C7D6A] mb-1">
                  No invoices yet
                </p>
                <p className="text-xs text-[#5A5040]">
                    ...
                    {invoices.map((invoice) => {
                      ...
                      return (
                        <tr
                          ...
                          className="hover:bg-white/[0.02] transition-colors"
                        >
                          <td className="px-5 py-4 text-xs font-mono text-[#8C7D6A]">
                            {invoiceNum}
                          </td>
                          <td className="px-5 py-4 text-xs text-[#8C7D6A] whitespace-nowrap">
