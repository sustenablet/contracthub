      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-lg border border-[#E2DED8] shadow-[0_1px_3px_rgba(0,0,0,0.05)] p-8 space-y-8 text-[14px] text-[#1F1B14]/75 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">1. Agreement to Terms</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">2. Use of the Service</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">3. Accounts</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">4. Free Trial and Subscription</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">5. Your Content</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">6. Privacy</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">7. Service Availability</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">8. Limitation of Liability</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">9. Disclaimer of Warranties</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">10. Termination</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">11. Changes to Terms</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">12. Governing Law</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-[16px] font-semibold text-[#1F1B14]">13. Contact</h2>
        ...
        <div className="mt-8 flex items-center justify-between text-[12px] text-[#1F1B14]/35">
          ...
          <Link href="/privacy" className="hover:text-[#1F1B14]/60 transition-colors">Privacy Policy →</Link>
        </div>
      </main>
    </div>
  );
